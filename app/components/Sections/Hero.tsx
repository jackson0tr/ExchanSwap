...
const Hero: FC<Props> = ({ activeItem, setOpen, route, open, setRoute }) => {
    ...
    return (
        <>
            <section id="hero" className="container  hero_bg flex items-center bg-[#fff] flex-col px-5 pt-[50px] lg:pt-[130px] pb-[50px]  mx-auto">
                <motion.div
            initial={{
              opacity:  0 ,
            //   : 0.5
          ...
          >
                <div className="mt-10 pb-3 flex items-center justify-center ">
                    <div className="flex flex-col  mt-[20px]">
                        <h4 className="text-white items-center text-center  text-[30px] px-3 w-full  font-[600] fonst-Josefin py-2 ">
                            Trusted Global Currency Converter & Money Transfers
                        </h4>
                        <br />
                        <p className="text-white items-center text-center font-Josefin font-[600] text-[18px]">
                        ...
                        <>                                
                            <div className="">
                                ...
                                <div className="flex p-3 flex-col 800px:flex-row">
                                    {convertedAmount && (
                                        <div className="mt-4 text-lg font-medium text-center 800px:text-right text-[#2190ff]">
                                    ...
                                    <div className="flex p-3 flex-col 800px:flex-row mt-6">
                                        ...
                                        <button
                                            ...
                                            className={`${style.button} !rounded-[5px] p-3 !w-[80px] !h-[40px] ${converting ? "animate-pulse" : ""}`}
                                        >
                                            Convert
                                        </button>
                                </div>
