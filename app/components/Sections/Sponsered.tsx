...
const Sponsered = () => {
  const row1 = [
    ...
    "https://www.vectorlogo.zone/logos/wikipedia/wikipedia-ar21.svg",
  ...
  return (
    <section className="container bg-[#fff] md:px-14 max-w-s mx-auto py-10 sponserCon">
      <div className="sponserWrapper">
        <h1 className="text-[30px] font-[600] text-slate-700 mb-2">
          Trusted By
        </h1>
        <div className="marque">
          <div className="marque-group">
            {
              row1.map((el:any, index:number)=>(
                <div className="image-group" key={index}>
                  <Image width={100} height={100} className="image" src={el} alt="img" />
                </div>
              ))
            }
          </div>
