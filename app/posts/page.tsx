...
const Page = () => {
    ...
    return (
        <AuthProvider>
            <div>
                <Heading
                    title='Posts ExchanSwap'
                    description="Posts Page. At ExchanSwap, we understand that currency exchange can be complex and that our users often have questions about our services, processes, and policies. Our Frequently Asked Questions (FAQ) page is designed to provide you with clear, concise, and accurate information to help you navigate your currency exchange needs with ease and confidence."
